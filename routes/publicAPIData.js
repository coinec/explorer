...
var ec_blockNumber = "ec_blockNumber";
var ec_getBlockByNumber = "ec_getBlockByNumber";
var ec_getBlockTransactionCountByNumber = "ec_getBlockTransactionCountByNumber";
var ec_getTransactionByHash = "ec_getTransactionByHash";
var ec_getTransactionByBlockNumberAndIndex = "ec_getTransactionByBlockNumberAndIndex";
var ec_getTransactionCount = "ec_getTransactionCount";
var ec_sendRawTransaction = "ec_sendRawTransaction";
var ec_getTransactionReceipt = "ec_getTransactionReceipt";
var ec_call = "ec_call";
var ec_getCode = "ec_getCode";
var ec_getStorageAt  = "ec_getStorageAt ";
var ec_gasPrice = "ec_gasPrice";
var ec_estimateGas = "ec_estimateGas";
      ...
      switch(methodName){
           ...
           Witness.findOne({"witness":address},"miner").exec((err, doc)=>{
              if(err)
                ...
                if(doc){
                  ...
                  eth.getBalance(doc.miner).then(function(data){
                    sendData(res, respData, data.toString());
                  })
                }else{
            ...
            // var addr = eth.getBalance(address).then(data=>console.log('xxxx:',data));
            // console.log(addr)
            // sendData(res, respData, addr);
        ...
        case balancemulti:
          ...
          for(let i=0; i<addresses; i++){
            ...
            // arr.push(balanceObj);
            eth.getBalance(addresses[i]).then(function(data){
              balanceObj.balance = data;
              arr.push(balanceObj);
            })
          }
